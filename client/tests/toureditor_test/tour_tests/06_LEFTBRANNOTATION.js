// leftbracket annotation Creation
webpage.sendEvent("click", 750, 24, 'left', 0); 
slimer.wait (500);
webpage.sendEvent("click", 750, 24, 'left', 0); 
slimer.wait (500);
webpage.sendEvent("click", 750, 163, 'left', 0); 
slimer.wait (500);
...
// Capture result
webpage.render('./'+output_dir+'/leftbracket_annotation.png', {onlyViewport:true}); 
...
slimer.wait (500);
// Capture result
webpage.render('./'+output_dir+'/leftbracket_annotation_moved.png', {onlyViewport:true}); 
...
// Capture result
webpage.render('./'+output_dir+'/leftbracket_annotation_resized.png', {onlyViewport:true}); 
...
if(undo_stack_length!=0){
	test_results.push(["leftbracket Annotation", true]);
}else{
	test_results.push(["leftbracket Annotation", false]);
} 
