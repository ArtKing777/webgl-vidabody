# BUILD AUTOTESTER - TOUR EDITOR TEST

do_upload = False # Do we upload the results to the server?
...
print "Auto-Build-Tester FOR TOUR EDITOR v0.2 \nTESTING BUILD ID "+build

# Run the automated test application
print "Running autotests\n----------------\n"
p = subprocess.Popen('slimerjs tour_editor_test.js', shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
